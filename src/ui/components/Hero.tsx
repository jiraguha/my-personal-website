  ...
  return (
    <section className="py-10 sm:py-14">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        <div className="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 hover:border-indigo-300 dark:hover:border-indigo-700 transition-colors p-6 sm:p-8">
          <div className="flex items-start gap-5 sm:gap-6">
            {/* Avatar */}
            <div className="shrink-0 w-16 h-16 sm:w-20 sm:h-20 rounded-full overflow-hidden bg-gradient-to-br from-indigo-400 to-violet-500 flex items-center justify-center ring-2 ring-indigo-300 dark:ring-indigo-700">
              {imgFailed ? (
